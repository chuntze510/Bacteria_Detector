# -*- coding: utf-8 -*-
"""
Created on Sat Oct 12 18:10:42 2019

@author: https://www.cnblogs.com/shouhuxianjian/p/10567201.html
"""
...
class WeightSaver(object):
    ...
    def __init__(self,h5_path,output_path):
        ...
        num_classes = 1
        self.model = yolo_body(Input(shape=(None, None, 3)), 3, num_classes) 
